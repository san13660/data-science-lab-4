...
# *
# 20/08/2020
# Programa para preprocesar los datos (limpieza de datos)
...
# Funcion que tiene todos los pasos de limpieza
...
# Leer archivo y por cada linea, aplicar la funcion de limpieza. Se genera un nuevo archivo con los datos ya limpios
